                                    ...
                                    <div class="control-group">
                                        ...
                                        <ul class="categories-filter animate-dropdown">
                                            <li class="dropdown">
                                                ...
                                                <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html-grid">Categories <b class="caret"></b></a>

                                                <ul class="dropdown-menu" role="menu" >
                                                    <li class="menu-header">Computer</li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html-grid">- Laptops</a></li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html-grid">- Tv & audio</a></li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html-grid">- Gadgets</a></li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html-grid">- Cameras</a></li>
                                ...
                                <div class="nav-outer">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown yamm-fw">
                                            <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">{{{ $categoria->nombre }}}</a>
                                        </li>
                                            @endforeach
                                        @else
                                            There are no categories my friend
                                        @endif
