...
{{ Form::model($presentationtype, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('presentationtypes.update', $presentationtype->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('presentationtypes.show', 'Cancel', $presentationtype->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
